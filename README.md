...
- **📍 Page-Level Citations**: Every answer is grounded in your documents with precise page numbers. Stop guessing where information came from.
...
- **Mica Aesthetics**: Seamlessly integrates with Windows 11 design language.
